...
- 专项后端 27 项、前端组件 4 项、前端全量 97 项、后端全量 277 项及 TypeScript、ESLint、Prettier、Ruff 已通过；Windows sidecar 与 Tauri release 构建通过，免安装程序 SHA-256 为 `96B3FD64DB1F09ABD48C4CB41D2A56E87A0CE4B532DDDC258E6130A950516156`。
